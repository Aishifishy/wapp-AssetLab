...
@section('title', 'Currently Borrowed Equipment')
@section('header', 'Currently Borrowed Equipment')
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                            <div>
                                                ...
                                                <dd class="mt-1">
                                                    <div class="text-sm font-medium text-gray-900">{{ $request->requested_from->format('M d, Y') }}</div>
                                            ...
                                            <div>
                                                ...
                                                <dd class="mt-1">
                                                    <div class="text-sm font-medium text-gray-900">{{ $request->requested_until->format('M d, Y') }}</div>
