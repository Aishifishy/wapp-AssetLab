...
@section('title', 'Create Equipment Category')

@section('content')
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Create Equipment Category</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="p-6">
            <form action="{{ route('admin.equipment.categories.store') }}" method="POST">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                ...
                                rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                placeholder="Category description">{{ old('description') }}</textarea>                        <x-form-error field="description" />
                    </div>
                </div>
