...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2 mt-4 sm:mt-0">
                <a href="{{ route('admin.super-admin.export.users') }}" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md transition duration-150 ease-in-out">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('admin.super-admin.reports') }}" class="space-y-4">
                        ...
                        <select name="academic_term_id" id="academic_term_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            @foreach($academicTerms as $term)
                                <option value="{{ $term->id }}" {{ $academicTermId == $term->id ? 'selected' : '' }}>
                                    {{ $term->academicYear->year_name ?? '' }} - {{ $term->term_name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    
                    <div id="date-from" class="{{ $period != 'custom' ? 'hidden' : '' }}">
                        <label for="date_from" class="block text-sm font-medium text-gray-700 mb-2">From Date</label>
                        <input type="date" name="date_from" id="date_from" value="{{ $dateFrom }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    
                    <div id="date-to" class="{{ $period != 'custom' ? 'hidden' : '' }}">
                        <label for="date_to" class="block text-sm font-medium text-gray-700 mb-2">To Date</label>
                        <input type="date" name="date_to" id="date_to" value="{{ $dateTo }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-6">
                <div class="text-center">
                    <div class="text-3xl font-bold text-blue-600">{{ $userStats['total_users'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Total Users</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-green-600">{{ $userStats['active_users_period'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Active in Period</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-indigo-600">{{ $userStats['new_users_period'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">New in Period</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-yellow-600">{{ $userStats['faculty_count'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Faculty</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-blue-600">{{ $userStats['student_count'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Students</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-gray-600">{{ $userStats['staff_count'] }}</div>
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-yellow-50 rounded-lg p-4 text-center">
                        <div class="text-2xl font-bold text-yellow-600">{{ $userStats['faculty_new_period'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">New Faculty</div>
                    </div>
                    <div class="bg-blue-50 rounded-lg p-4 text-center">
                        <div class="text-2xl font-bold text-blue-600">{{ $userStats['student_new_period'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">New Students</div>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-4 text-center">
                        <div class="text-2xl font-bold text-gray-600">{{ $userStats['staff_new_period'] }}</div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="text-center">
                    <div class="text-3xl font-bold text-blue-600">{{ $adminStats['total_admins'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Total Admins</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-yellow-600">{{ $adminStats['super_admins'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Super Admins</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-indigo-600">{{ $adminStats['regular_admins'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">Regular Admins</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-green-600">{{ $adminStats['new_admins_period'] }}</div>
                    <div class="text-sm text-gray-500 mt-1">New in Period</div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-blue-600">{{ $equipmentStats['total_equipment'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">Total Equipment</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ $equipmentStats['available_equipment'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">Available</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-yellow-600">{{ $equipmentStats['borrowed_equipment'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">Borrowed</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-red-600">{{ $equipmentStats['maintenance_equipment'] }}</div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                            ...
                            <span class="text-lg font-semibold text-blue-600">{{ $equipmentStats['requests_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                            <span class="text-sm text-gray-600">Approved</span>
                            <span class="text-lg font-semibold text-green-600">{{ $equipmentStats['approved_requests_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                            <span class="text-sm text-gray-600">Rejected</span>
                            <span class="text-lg font-semibold text-red-600">{{ $equipmentStats['rejected_requests_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                            <span class="text-sm text-gray-600">Pending</span>
                            <span class="text-lg font-semibold text-yellow-600">{{ $equipmentStats['pending_requests'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-blue-600">{{ $labStats['total_laboratories'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">Total Labs</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ $labStats['available_laboratories'] }}</div>
                        <div class="text-sm text-gray-500 mt-1">Available</div>
                    </div>
                </div>
                <hr class="my-4 border-gray-200">
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                            ...
                            <span class="text-lg font-semibold text-blue-600">{{ $labStats['reservations_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                            <span class="text-sm text-gray-600">Approved</span>
                            <span class="text-lg font-semibold text-green-600">{{ $labStats['approved_reservations_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm text-gray-600">Completed</span>
                            <span class="text-lg font-semibold text-gray-600">{{ $labStats['completed_reservations_period'] }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                            <span class="text-sm text-gray-600">Pending</span>
                            <span class="text-lg font-semibold text-yellow-600">{{ $labStats['pending_reservations'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500">{{ $equipment->category->name ?? 'No Category' }}</p>
                            </div>
                            <div class="text-right">
                                <div class="text-lg font-semibold text-orange-600">{{ $equipment->borrow_requests_count }}</div>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                @if($popularLabs->count() > 0)
                    <div class="space-y-3">
                        @foreach($popularLabs as $lab)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex-1">
                                <h3 class="text-sm font-medium text-gray-900">{{ $lab->name }}</h3>
                                <p class="text-xs text-gray-500">Room {{ $lab->room_number }}, {{ $lab->building }}</p>
                            </div>
                            <div class="text-right">
                                <div class="text-lg font-semibold text-emerald-600">{{ $lab->reservations_count }}</div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('admin.super-admin.admins.create') }}" class="flex flex-col items-center justify-center p-6 bg-blue-50 hover:bg-blue-100 rounded-lg transition duration-150 ease-in-out text-center">
                    <i class="fas fa-user-plus text-3xl text-blue-600 mb-3"></i>
                    <span class="text-sm font-medium text-blue-900">Add New Admin</span>
                </a>
                <a href="{{ route('admin.super-admin.users.create') }}" class="flex flex-col items-center justify-center p-6 bg-green-50 hover:bg-green-100 rounded-lg transition duration-150 ease-in-out text-center">
                    <i class="fas fa-user-plus text-3xl text-green-600 mb-3"></i>
                    <span class="text-sm font-medium text-green-900">Add New User</span>
                </a>
                <a href="{{ route('admin.equipment.index') }}" class="flex flex-col items-center justify-center p-6 bg-orange-50 hover:bg-orange-100 rounded-lg transition duration-150 ease-in-out text-center">
                    <i class="fas fa-tools text-3xl text-orange-600 mb-3"></i>
                    <span class="text-sm font-medium text-orange-900">Manage Equipment</span>
                </a>
                <a href="{{ route('admin.laboratory.index') }}" class="flex flex-col items-center justify-center p-6 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition duration-150 ease-in-out text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">{{ $adminStats['super_admins'] }} Active</p>
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        @if($equipmentStats['pending_requests'] > 10)
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">{{ $equipmentStats['pending_requests'] }} Equipment, {{ $labStats['pending_reservations'] }} Lab</p>
                    </div>
                </div>
            </div>
        </div>
