            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <?php $__currentLoopData = $labelSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none hover:bg-gray-50">
                                <input type="radio" name="label_size" value="<?php echo e($key); ?>" 
                                       class="sr-only" 
                                       <?php echo e($key === 'standard' ? 'checked' : ''); ?>>
...
<?php endif; ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="<?php echo e(route('admin.equipment.barcode.single', $item)); ?>?label_size=standard" 
...
function exportAllBarcodes() {
    ...
    window.open(`<?php echo e(route('admin.equipment.barcode.all')); ?>?label_size=${labelSize}`, '_blank');
}
