    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-primary transition-colors">
                            Login
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('register')); ?>" class="text-gray-600 hover:text-primary transition-colors">
                            Register
                        </a>
                    </li>
                    <li>
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
            <p class="text-center text-gray-400 text-sm">
                &copy; <?php echo e(date('Y')); ?> ResourEase. All rights reserved.
            </p>
        </div>
    </div>
</footer> <?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views\layouts\footer.blade.php ENDPATH**/ ?>