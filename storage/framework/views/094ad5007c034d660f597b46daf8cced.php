                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-4 mb-2">
                                        <h4 class="text-lg font-medium text-gray-900"><?php echo e($request->laboratory->name); ?></h4>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                        <div>
                                            <p><strong>Requested by:</strong> <?php echo e($request->user->name); ?></p>
                                            <p><strong>Date:</strong> <?php echo e($request->reservation_date->format('M d, Y')); ?></p>
                                            <p><strong>Time:</strong> <?php echo e($request->start_time->format('h:i A')); ?> - <?php echo e($request->end_time->format('h:i A')); ?></p>
                                            <p><strong>Duration:</strong> <?php echo e($request->duration); ?></p>
                                        </div>
                                        <div>
                                            <p><strong>Purpose:</strong> <?php echo e($request->purpose); ?></p>
                                            <p><strong>Students:</strong> <?php echo e($request->num_students ?? 'Not specified'); ?></p>
                                            <p><strong>Course:</strong> <?php echo e($request->course_code ?? 'Not specified'); ?></p>
                                            <p><strong>Subject:</strong> <?php echo e($request->subject ?? 'Not specified'); ?></p>
                                            <?php if($request->section): ?>
                                                <p><strong>Section:</strong> <?php echo e($request->section); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php if($request->is_recurring): ?>
                                        <div class="mt-2 p-2 bg-blue-50 border border-blue-200 rounded">
                                            <p class="text-sm text-blue-700">
                                                <i class="fas fa-repeat mr-1"></i>
                                                <strong>Recurring:</strong> <?php echo e(ucfirst($request->recurrence_pattern)); ?> 
                                                until <?php echo e($request->recurrence_end_date->format('M d, Y')); ?>

                                            </p>
                                        </div>
                                    <?php endif; ?>
                                    <p class="text-xs text-gray-500 mt-2">
                                        Requested <?php echo e($request->created_at->diffForHumans()); ?>
            ...
            <?php if($recentRequests->count() > 0): ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $recentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border-l-4 <?php echo e($request->status === 'approved' ? 'border-green-400 bg-green-50' : 'border-red-400 bg-red-50'); ?> p-4 rounded-r-lg">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-3 mb-2">
                                        <h4 class="font-medium text-gray-900"><?php echo e($request->laboratory->name); ?></h4>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($request->status === 'approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                            <?php echo e(ucfirst($request->status)); ?>

                                        </span>
                                        <span class="text-sm text-gray-500"><?php echo e($request->updated_at->diffForHumans()); ?></span>
                                    </div>
                                    <div class="text-sm text-gray-600">
                                        <p><strong>User:</strong> <?php echo e($request->user->name); ?></p>
                                        <p><strong>Date & Time:</strong> <?php echo e($request->reservation_date->format('M d, Y')); ?> • <?php echo e($request->start_time->format('h:i A')); ?> - <?php echo e($request->end_time->format('h:i A')); ?></p>
                                        <p><strong>Purpose:</strong> <?php echo e($request->purpose); ?></p>
                                        <?php if($request->status === 'rejected' && $request->rejection_reason): ?>
                                            <p class="mt-2 p-2 bg-red-100 border border-red-200 rounded text-red-700">
                                                <strong>Rejection Reason:</strong> <?php echo e($request->rejection_reason); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views\admin\laboratory\requests.blade.php ENDPATH**/ ?>