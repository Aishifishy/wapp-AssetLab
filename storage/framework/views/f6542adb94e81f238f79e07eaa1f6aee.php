    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="p-6">
            ...
            <!-- Equipment Grid -->            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white border rounded-lg overflow-hidden hover:shadow-md transition-shadow" data-category-id="<?php echo e($item->category_id); ?>">
                    <div class="p-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">
                                    <?php if(isset($categories)): ?>
                                        <?php echo e($categories->firstWhere('id', $item->category_id)->name ?? 'Uncategorized'); ?>
