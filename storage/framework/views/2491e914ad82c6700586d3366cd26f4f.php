...
<?php $__env->startSection('title', 'Edit Equipment Type'); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Edit Equipment Type</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="p-6">
            <form action="<?php echo e(route('admin.equipment.categories.update', $category)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                ...
                                rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                placeholder="Equipment type description"><?php echo e(old('description', $category->description)); ?></textarea>                        <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i> Update Equipment Type
                    </button>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views\admin\equipment\categories\edit.blade.php ENDPATH**/ ?>