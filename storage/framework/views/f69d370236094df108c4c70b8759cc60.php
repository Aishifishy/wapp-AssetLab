...
<div class="row">
    ...
    <div class="col-12 col-lg-6 mb-4">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="<?php echo e(route('admin.equipment.index')); ?>" class="mt-4 d-inline-flex align-items-center text-blue-600 hover:text-blue-800 text-sm">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4 text-sm text-gray-900">
                                ...
                                <?php endif; ?>
                                <?php if(isset($activity->admin_info) && $activity->admin_info): ?>
                                <p class="text-xs text-blue-600 mt-1 font-medium"><?php echo e($activity->admin_info); ?></p>
                                <?php endif; ?>
                            </td>
...
<?php $component = App\View\Components\StatusBadge::resolve(['status' => $activity->status ?? 'unknown','type' => $activity->activity_type === 'equipment' ? 'request' : 'reservation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            ...
                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                <?php if($activity->activity_type === 'equipment'): ?>
                                    <a href="<?php echo e(route('admin.equipment.borrow-requests')); ?>" class="text-blue-600 hover:text-blue-900 font-medium">
                                        View Details
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('admin.laboratory.reservations')); ?>" class="text-blue-600 hover:text-blue-900 font-medium">
                                        View Details
                                    </a>
                                <?php endif; ?>
                            </td>
