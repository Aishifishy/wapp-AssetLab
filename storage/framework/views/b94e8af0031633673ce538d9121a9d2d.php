                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <?php if($request->status === 'pending'): ?>
                                    <div class="flex flex-col space-y-1">
                                        ...
                                        <?php if($request->reservation_date && $request->laboratory_id): ?>
                                ...
                                <?php elseif($request->status === 'approved' && $request->reservation_date && $request->laboratory_id): ?>
                                    <div class="flex flex-col space-y-1">
                                        <span class="text-gray-400 text-sm">Processed <?php echo e($request->updated_at->diffForHumans()); ?></span>
                                        <a href="<?php echo e(route('admin.laboratory.create-override', [
                                            'date' => $request->reservation_date->format('Y-m-d'),
                                            'laboratory_id' => $request->laboratory_id,
                                            'requested_by' => $request->user_id
