...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.comlab.calendar')); ?>" class="btn btn-secondary">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            Edit Schedule for <?php echo e($laboratory->name); ?> (<?php echo e($laboratory->building); ?> - <?php echo e($laboratory->room_number); ?>)
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.comlab.schedule.update', [$laboratory, $schedule])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="subject_code" class="form-label">Subject Code</label>                            <input type="text" class="form-control <?php $__errorArgs = ['subject_code'];
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('subject_code', $schedule->subject_code)); ?>" maxlength="20">
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            <label for="subject_name" class="form-label">Subject Name</label>                            <input type="text" class="form-control <?php $__errorArgs = ['subject_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('subject_name', $schedule->subject_name)); ?>" required maxlength="100">
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            <label for="instructor_name" class="form-label">Instructor Name</label>                            <input type="text" class="form-control <?php $__errorArgs = ['instructor_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('instructor_name', $schedule->instructor_name)); ?>" required maxlength="100">
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            <label for="section" class="form-label">Section</label>                            <input type="text" class="form-control <?php $__errorArgs = ['section'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('section', $schedule->section)); ?>" required maxlength="20">
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="0" <?php echo e(old('day_of_week', $schedule->day_of_week) === 0 ? 'selected' : ''); ?>>Sunday</option>
                                <option value="1" <?php echo e(old('day_of_week', $schedule->day_of_week) === 1 ? 'selected' : ''); ?>>Monday</option>
                                <option value="2" <?php echo e(old('day_of_week', $schedule->day_of_week) === 2 ? 'selected' : ''); ?>>Tuesday</option>
                                <option value="3" <?php echo e(old('day_of_week', $schedule->day_of_week) === 3 ? 'selected' : ''); ?>>Wednesday</option>
                                <option value="4" <?php echo e(old('day_of_week', $schedule->day_of_week) === 4 ? 'selected' : ''); ?>>Thursday</option>
                                <option value="5" <?php echo e(old('day_of_week', $schedule->day_of_week) === 5 ? 'selected' : ''); ?>>Friday</option>
                                <option value="6" <?php echo e(old('day_of_week', $schedule->day_of_week) === 6 ? 'selected' : ''); ?>>Saturday</option>                            </select>
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            <label for="start_time" class="form-label">Start Time</label>                            <input type="time" class="form-control <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('start_time', $schedule->start_time->format('H:i'))); ?>" required>
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="mb-3">
                            <label for="end_time" class="form-label">End Time</label>                            <input type="time" class="form-control <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                value="<?php echo e(old('end_time', $schedule->end_time->format('H:i'))); ?>" required>
                            <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="regular" <?php echo e(old('type', $schedule->type) === 'regular' ? 'selected' : ''); ?>>Regular</option>
                                <option value="special" <?php echo e(old('type', $schedule->type) === 'special' ? 'selected' : ''); ?>>Special</option>
...
unset($__errorArgs, $__bag); ?>" 
                        id="notes" name="notes" rows="3"><?php echo e(old('notes', $schedule->notes)); ?></textarea>                    <?php if (isset($component)) { $__componentOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc93285135aa759ebaf0b3dc38aeeeb0d = $attributes; } ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views\admin\comlab\schedule\edit.blade.php ENDPATH**/ ?>