    ...
    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                <ul class="space-y-4">
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-300 hover:text-white transition-all duration-300 flex items-center group">
                    ...
                    <li>
                        <a href="<?php echo e(route('register')); ?>" class="text-gray-300 hover:text-white transition-all duration-300 flex items-center group">
                            <svg class="w-4 h-4 mr-3 text-blue-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-center">
                <div class="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6 mb-6 lg:mb-0">
                    <p class="text-gray-400 text-sm">
                        &copy; <?php echo e(date('Y')); ?> AssetLab. All rights reserved. | National University - Laguna
                    </p>
                </div>
...
</footer> <?php /**PATH C:\xampp\htdocs\wapp-AssetLab\resources\views/layouts/footer.blade.php ENDPATH**/ ?>