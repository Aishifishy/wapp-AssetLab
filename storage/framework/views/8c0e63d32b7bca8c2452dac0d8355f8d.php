...
<?php endif; ?>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            ...
            <?php else: ?>
                <form id="reservation-form" action="<?php echo e(route('ruser.laboratory.reservations.store', $laboratory)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateScheduleForDate() {
        ...
        if (date) {
            fetch(`<?php echo e(route('ruser.laboratory.time-slots-overview', $laboratory)); ?>?date=${encodeURIComponent(date)}`)
            .then(response => response.json())
            .then(data => {
...
<?php echo $__env->make('layouts.ruser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wapp-AssetLab\resources\views/ruser/laboratory/reservation/create.blade.php ENDPATH**/ ?>