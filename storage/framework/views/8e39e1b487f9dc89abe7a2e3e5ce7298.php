...
<?php $__env->startSection('header', 'RFID Equipment Management'); ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $equipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500"><?php echo e($item->rfid_tag ?? 'Not Set'); ?></div>
...
<?php endif; ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <button data-action="edit-equipment" data-equipment-id="<?php echo e($item->id); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Edit</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views/admin/equipment/manage.blade.php ENDPATH**/ ?>