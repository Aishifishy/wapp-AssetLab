        ...
        <div class="p-6">
            ...
            <?php if($categories->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="group">
                        <a href="<?php echo e(route('ruser.equipment.borrow', ['category' => $category->id])); ?>" 
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center text-sm text-gray-500">
                                        ...
                                        <?php echo e($category->equipment_count); ?> <?php echo e(Str::plural('item', $category->equipment_count)); ?> available
                                    </div>
...
<?php echo $__env->make('layouts.ruser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\wappResourEase\resources\views/ruser/equipment/categories.blade.php ENDPATH**/ ?>